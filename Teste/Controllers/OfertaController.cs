...
namespace Teste.Controllers
{
    public class OfertaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone,CPF")] Oferta oferta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone,CPF")] Oferta oferta)
        {
            if (id != oferta.Id)
            {
                return NotFound();
